...
%%
%% See below for additional modifications by Ville Tuulos / Nokia Corporation
%%
...
%%
%% file_io modified by Ville Tuulos
%% s/file:/prim_file:/
%% s/filelib:ensure_dir/disco:ensure_dir/
%%
